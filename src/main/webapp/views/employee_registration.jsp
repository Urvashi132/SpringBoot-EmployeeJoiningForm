...
<body>
	...
	<form:form class="container" action="employee_form" model="emp"
		method="post">
									...
									<div class="card-body p-md-5 text-black ">
										...
										<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-6 mb-4">
													<div class="form-outline">
														<label class="required" for="form3Example9">DOB</label> <input
															type="text" id="form3Example9" name="dateOfBirth"
	...
	<div class="footer fixed-bottom"
		...
		<div class="text">
			<p>@Copyright 2022 Adjecti Solution Pvt Ldt.</p>
		</div>
	</div>
</body>
</html>